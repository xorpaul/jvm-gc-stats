    ...
    def parse(self, t):
        ...
        for line in loglines:
            ...
            if regexParNew.match(line):
                ...
                datum['old_kb_before'] = int(regexProFail.match(line).group(4))
                datum['old_kb_after'] = int(regexProFail.match(line).group(5))
