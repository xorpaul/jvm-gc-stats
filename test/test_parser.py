...
class TestParser(unittest.TestCase):
    ...
    def testFull(self):
        ...
        values = {'test': {'full': {'count': 1, 'permgen_kb_collected': 125, 'newgen_kb_collected': 0, 'avg_real_time': '0.32', 'max_user_time': '0.30', 'avg_newgen_kb_collected': 0, 'avg_oldgen_kb_collected': -17375, 'total_kb_collected': 200744, 'max_real_time': '0.32', 'avg_user_time': '0.30', 'max_sys_time': '0.01', 'avg_permgen_kb_collected': 125, 'real_time': '0.32', 'sys_time': '0.01', 'oldgen_kb_collected': -17375, 'avg_total_kb_collected': 200744, 'avg_sys_time': '0.01', 'user_time': '0.30'}}, 'errors': 0}
        self.assert_parsed(line, values)
    ...
    def testFulln(self):
        ...
        values = {'test': {'full': {'count': 1, 'permgen_kb_collected': 24, 'newgen_kb_collected': 3936, 'avg_real_time': '0.33', 'max_user_time': '2.75', 'avg_newgen_kb_collected': 3936, 'avg_oldgen_kb_collected': 131484, 'total_kb_collected': 135420, 'max_real_time': '0.33', 'avg_user_time': '2.75', 'max_sys_time': '0.21', 'avg_permgen_kb_collected': 24, 'real_time': '0.33', 'sys_time': '0.21', 'oldgen_kb_collected': 131484, 'avg_total_kb_collected': 135420, 'avg_sys_time': '0.21', 'user_time': '2.75'}}, 'errors': 0}
        self.assert_parsed(line, values)
    ...
    def testCMSc(self):
        ...
        values = {'test': {'cms_concurrent_mark': {'count': 1, 'avg_real_time': '3.33', 'max_user_time': '13.02', 'max_real_time': '3.33', 'avg_user_time': '13.02', 'max_sys_time': '0.31', 'real_time': '3.33', 'sys_time': '0.31', 'avg_sys_time': '0.31', 'user_time': '13.02'}}, 'errors': 0}
        self.assert_parsed(line, values)
        ...
        values = {'test': {'cms_concurrent_sweep': {'count': 1, 'avg_real_time': '20.13', 'max_user_time': '40.81', 'max_real_time': '20.13', 'avg_user_time': '40.81', 'max_sys_time': '7.39', 'real_time': '20.13', 'sys_time': '7.39', 'avg_sys_time': '7.39', 'user_time': '40.81'}}, 'errors': 0}
        self.assert_parsed(line, values)
        ...
        values = {'test': {'cms_concurrent_preclean': {'count': 1, 'avg_real_time': '0.04', 'max_user_time': '0.03', 'max_real_time': '0.04', 'avg_user_time': '0.03', 'max_sys_time': 0, 'real_time': '0.04', 'sys_time': '0.00', 'avg_sys_time': '0.00', 'user_time': '0.03'}}, 'errors': 0}
        self.assert_parsed(line, values)
    ...
    def testMultipleTypes(self):
        ...
        values = {'test': {'full': {'count': 1, 'permgen_kb_collected': 125, 'newgen_kb_collected': 0, 'avg_real_time': '0.32', 'max_user_time': '0.30', 'avg_newgen_kb_collected': 0, 'avg_oldgen_kb_collected': -17375, 'total_kb_collected': 200744, 'max_real_time': '0.32', 'avg_user_time': '0.30', 'max_sys_time': '0.01', 'avg_permgen_kb_collected': 125, 'real_time': '0.32', 'sys_time': '0.01', 'oldgen_kb_collected': -17375, 'avg_total_kb_collected': 200744, 'avg_sys_time': '0.01', 'user_time': '0.30'}, 'ps_young_gen': {'count': 1, 'newgen_kb_collected': 96000, 'avg_real_time': '0.02', 'max_user_time': '0.07', 'avg_newgen_kb_collected': 96000, 'avg_total_kb_collected': 96000, 'total_kb_collected': 96000, 'max_real_time': '0.02', 'avg_user_time': '0.07', 'max_sys_time': 0, 'real_time': '0.02', 'sys_time': '0.00', 'avg_sys_time': '0.00', 'user_time': '0.07'}}, 'errors': 0}
        p = Parser.Parser()
